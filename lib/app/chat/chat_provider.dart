...
// Inside ChatProvider
  ...
  Future<void> _imageGenerationLogic({
    ...
    String? stylePreset = (prefs.getString(ImageEqSharedPrefKeys.stylePreset));
    ...
    await Future.wait(
        imageMessages.map((message) => _chatRepository.createMessage(message)));
  }
